...
public class BarberAcceptedOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_barber_accepted_orders,container,false);
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot != null){
                    orders.clear();
                    SharedPreferences sp = getActivity().getSharedPreferences(PREFERENCES_NAME, MODE_PRIVATE);                    Log.d("AKUMA", "getting orders ...");
                    ...
                    if(dataSnapshot1.child("state").getValue() != null ) {
                        if (dataSnapshot1.child("state").getValue().toString().equals("accepted") &&dataSnapshot1.child("to").getValue().toString().equals(sp.getString("name","")) ) {
